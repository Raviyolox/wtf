          ...
          <div className="relative">
            <div className="flex flex-col lg:flex-row justify-between w-full p-6 px-8 items-center h-full">
              <div className="flex flex-col lg:justify-start justify-center items-center lg:items-start mt-5 lg:mt-0 w-full">
                ...
                <p className="text-white/50 text-md mt-3">Switch Client Sonoyuncu hilesi
                </p>
              </div>
              <div className={`order-first lg:order-last flex-shrink-0 relative w-[160px] h-[160px] rounded-full pulse-avatar-online `}>
                <img alt="Switch Client" src={`https://cdn.discordapp.com/attachments/996782609709416538/1002252055844487178/th.jpeg`} width="160" height="160" className={`bg-neutral-700 w-[160px] h-[160px] rounded-full`} />
            ...
            ? repositories
              ? repositories
                  ...
                  .map((_, __) => (
                    <a
                      key={__}
                      href={`https://github.com/Raviyolox/`+_.name}
                      target="_blank"
                      rel="noreferrer"
